...
export default function Portal() {
  return (
    <PortalLayout>
      <div className=" bg-white font-nunito lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex lg:flex-row items-center flex-col  gap-12 max-w-7xl mx-auto">
          <div className="w-full lg:w-1/2">
            <h2 className="text-slate-900 w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
              Welcome to the User Portal 🚀
            </h2>
            <p className="font-normal text-base leading-loose text-gray-600 mt-6">
              At the heart of our commitment to safety and justice, we present
              the Blockchain FIR System, a pioneering approach to incident
              reporting and transparency. This platform empowers you to report
              incidents to law enforcement agencies securely and with the
              assurance of immutability provided by blockchain technology.
            </p>
          </div>
          <div className="w-full lg:w-1/2">
            <Image
              src="/images/blockchainImage.png"
              width={600}
              height={600}
              alt="Portal"
            />
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Sign up for an account, ensuring your information is protected and
          ...
          <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Report incidents easily by providing essential details, helping
              law enforcement respond effectively. 📝
            </p>
          </div>
          <div className="sm:block hidden">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Keep tabs on the status of your FIR, from submission to
              resolution. 🔄
            </p>
          </div>
        </div>
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            ...
            <div className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
              <li>
                Transparency: Our use of blockchain technology guarantees the
                integrity and transparency of your reports.
              </li>
              <li>
                {" "}
                Security: Your data and personal information are protected
                through robust authentication and encryption protocols.{" "}
              </li>
              <li>
                Efficiency: We strive to streamline the incident reporting
                process, helping law enforcement respond promptly.
              </li>
              <li>
                {" "}
                Accountability: Hold authorities accountable for their actions,
                as every FIR is traceable on the blockchain.
              </li>
              <br />
              Your safety and security matter to us. Join the Blockchain FIR
              System today and be part of a revolution in incident reporting.
              Together, we can ensure a safer and more just society. 🌟👥
            </div>
          </div>
          <div className="w-full lg:w-6/12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
              ...
              <div className="flex p-4 shadow-md">
                <div className="mr-6">
                  <GrCompliance className="text-4xl text-gray-800" />
                </div>
                <div className="">
                  <p className="font-normal text-base leading-6 text-gray-600">
                    Grievance can be lodged by any individual. / शिकायत कोई भी
                    व्यक्ति दर्ज करा सकता है
                  </p>
                </div>
              </div>
              ...
              <div className="flex p-4 shadow-md">
                <div className="mr-6">
                  <BsBell className="text-4xl text-gray-800" />
                </div>
                <div className="">
                  <p className=" font-normal text-base leading-6 text-gray-600">
              ...
              <div className="flex p-4 shadow-md">
                <div className="mr-6">
                  <AiOutlineFolderView className="text-4xl text-gray-800" />
                </div>
                <div className="">
                  <p className="font-normal text-base leading-6 text-gray-600">
